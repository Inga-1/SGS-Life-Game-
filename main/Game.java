...
//-----------METHODS FOR DYING----------------------------------------------------------------------------------------------
    ...
    public void endOfWorld(){
        if(!gameThread.isInterrupted()) {
            System.out.println("\n\n-----------------------------!EVENT!--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
            System.out.println("-  -  -  -  -  -  - E N D   O F   T H E   W O R L D -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -  -  -");
    ...
    public void rebellion(){
        if (cult.cult.size()>19 && !gameThread.isInterrupted()) {
            System.out.println("\n\n-----------------------------!EVENT!--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
            System.out.println("-  -  -  -  -  -  -  -  -  R E B E L L I O N  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  - -  -  -  -  -  -  -  -  -  -  -  -  -  -");
            System.out.println("\nThere had always been some tension in the cult, most members were not 100% convinced by " + this.cultLeader.name + " " + this.cultLeader.surname + ", but still they stuck around to see where that was going. \n" + this.cultLeader.name + " thought their charisma would be enough to pull it off, however they did not expect that their members would start questioning them and turn against them. \nAnd as quickly as it started it quickly vanished.");
            System.out.println("\n---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------");
            terminateGame();
        }
    }
